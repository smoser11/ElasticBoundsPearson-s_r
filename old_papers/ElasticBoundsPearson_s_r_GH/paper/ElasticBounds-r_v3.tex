There's a lot of good stuff in there% Options for packages loaded elsewhere
...
\subsubsection{\texorpdfstring{1. \textbf{Introduction and Conceptual
Framework}}{1. Introduction and Conceptual Framework}}\label{introduction-and-conceptual-framework}
...
\subsubsection{\texorpdfstring{2. \textbf{Theoretical Bounds on
Correlation
Coefficients}}{2. Theoretical Bounds on Correlation Coefficients}}\label{theoretical-bounds-on-correlation-coefficients}
...
\subsubsection{\texorpdfstring{3. \textbf{Measurement Issues and Metrics
of
Constraint}}{3. Measurement Issues and Metrics of Constraint}}\label{measurement-issues-and-metrics-of-constraint}
...
\item
  Proposed metrics of constraint: linear and squared shrinkage measures
\item
  R² interpretation under bounded conditions
\end{itemize}

\subsubsection{\texorpdfstring{4. \textbf{Simulations and Monte Carlo
Approaches}}{4. Simulations and Monte Carlo Approaches}}\label{simulations-and-monte-carlo-approaches}
...
\subsubsection{\texorpdfstring{5. \textbf{Empirical Illustration Using
BES
Data}}{5. Empirical Illustration Using BES Data}}\label{empirical-illustration-using-bes-data}
...
\subsubsection{\texorpdfstring{6. \textbf{Implications for Applied
Research and
Tools}}{6. Implications for Applied Research and Tools}}\label{implications-for-applied-research-and-tools}
...
\item
  ...
  \end{itemize}
\item
  Reframing effect size: from absolute value to bounded context and
  RE-SCALING:
...
\subsubsection{\texorpdfstring{7. \textbf{Open
Questions}}{7. Open Questions}}\label{open-questions}

\subsubsection{\texorpdfstring{8.
\textbf{Conclusions}}{8. Conclusions}}\label{conclusions}

(\citeproc{ref-hard}{\textbf{hard?}})
...
Constraint}\label{measurement-issues-and-metrics-of-constraint-1}
