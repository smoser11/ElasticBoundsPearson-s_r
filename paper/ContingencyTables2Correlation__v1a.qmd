...
where explicitly defined frequencies $M_{i,j}$ pair observations in a comonotonic manner, calculated explicitly via the greedy iterative approach outlined below.
...
and the cumulative frequencies for $Y$ (from 'bottom-up') are:
