...
\subsection{\texorpdfstring{\textbf{Interpretation of `Effect
Size'}}{Interpretation of `Effect Size'}}\label{interpretation-of-effect-size}
...
\subsection{\texorpdfstring{\textbf{Comparison Across Studies /
Measures}}{Comparison Across Studies / Measures}}\label{comparison-across-studies-measures}
...
\subsection{\texorpdfstring{\textbf{Rescaling}}{Rescaling}}\label{rescaling}
...
\item
  ...
  \item
    ...
    variables)
  \item
    is \(r^2_{max}\) the \ldots. maximal `amount' of variance between
    the two ordcats? How is this quantity to be interpreted? How is
