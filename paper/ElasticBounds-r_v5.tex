...
(\citeproc{ref-alwi91-reliability}{\textbf{alwi91-reliability?}});
(\citeproc{ref-brew05-values}{\textbf{brew05-values?}});
(\citeproc{ref-flor04-empirical}{\textbf{flor04-empirical?}});
(\citeproc{ref-gait80-measurement}{\textbf{gait80-measurement?}});
(\citeproc{ref-gree97-effect}{\textbf{gree97-effect?}}); Jacoby
(\citeproc{ref-jaco99-levels}{1999});
(\citeproc{ref-kend38-new}{\textbf{kend38-new?}});
(\citeproc{ref-knok02-statistics}{\textbf{knok02-statistics?}});
(\citeproc{ref-kreu07-survey}{\textbf{kreu07-survey?}});
(\citeproc{ref-kros97-designing}{\textbf{kros97-designing?}}); Labovitz
(\citeproc{ref-labo70-assignment}{1970});
(\citeproc{ref-olss79-maximum}{\textbf{olss79-maximum?}});
(\citeproc{ref-spea04-proof}{\textbf{spea04-proof?}})
...
Jacoby, W. G. (1999). Levels of {Measurement} and {Political Research}:
{An Optimistic View}. \emph{American Journal of Political Science},
\emph{43}(1), 271--301.
