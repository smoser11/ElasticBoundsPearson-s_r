...
((\citeproc{ref-labo70-assignment}{Labovitz, 1970});
(\citeproc{ref-gait80-measurement}{Gaito, 1980})), it remains routine in
...
(\citeproc{ref-kind09-us}{Kinder \& Kam, 2009})), and summary indices
that are subsequently modeled using correlation-based techniques.
Reviews document that such practices are pervasive in applied survey
analysis ((\citeproc{ref-kreu07-survey}{Kreuter \& Valliant, 2007})).
...
((\citeproc{ref-spea04-proof}{Spearman, 1904});
(\citeproc{ref-kend38-new}{Kendall, 1938});
(\citeproc{ref-olss79-maximum}{Olsson, 1979})). Rank-based measures
...
(\citeproc{ref-muth84-generl}{\textbf{muth84-generl?}});
(\citeproc{ref-bart11-latent}{Bartholomew et al., 2011})). For
survey-based political science and sociology, this means that
correlations reported between Likert items are not only bounded by their
marginals, but may also systematically bias downstream modeling.
