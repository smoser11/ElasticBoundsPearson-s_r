...
(\citeproc{ref-thor00-coupling}{Thorisson, 2000})). These results
provide the theoretical backbone for our derivations of \(r_{\min}\) and
\(r_{\max}\).
...
(\citeproc{ref-muth84-general}{Muthén, 1984});
