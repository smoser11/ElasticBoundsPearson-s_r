...
(The proof is in
(\citeproc{ref-proof-max-product}{\textbf{proof-max-product?}}))
...
\emph{Proof.} See \hyperref[proof-cor-min]{Proof A.2}
...
\textbf{Proof of \hyperref[cor-min]{Corollary \textbf{?@cor-min}}.}
