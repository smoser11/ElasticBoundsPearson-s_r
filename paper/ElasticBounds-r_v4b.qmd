...
-   Can $r_{min} >0$?
-  Show $|r_{min}| \ge r_{max}$ _in the population_.  Discuss how this is often violated by _estimates_ of these quantities (Cees and BES pairs)
...
### **6. Implications, Issues, and Questions**
...
```
:::
 (The proof is in @proof-max-product)
 ...
 *Proof.* See [Proof A.2](#proof-cor-min)
...
In this section we further explore the 
...
- Interpretation of 'effect size' (@cohe02-applied)
- Comparison
...
## Proof A.2 {#proof-cor-min}
**Proof of [Corollary @cor-min](#cor-min).**
