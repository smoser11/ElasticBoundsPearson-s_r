...
\textbf{Proposed Section Structure --- Unified Draft Outline}
...
\begin{itemize}
\item
  \textbf{Purpose:} Introduce the problem and why it matters.
\item
  Motivation: Researchers assume \emph{r} ∈ {[}--1, 1{]} is attainable
  for any data, but discrete marginals constrain attainable range.
\item
  Consequences: Misinterpretation of effect sizes, misleading hypothesis
  tests, cross-study comparison issues.
\item
  Contributions:
  ...
  \def\labelenumi{\arabic{enumi}.}
  \item
    Theoretical derivation and characterization of attainable bounds.
  \item
    Metrics to quantify constraint and asymmetry.
  \item
    Rescaling approaches for interpretation.
  \item
    Illustration through simulation and applied example (BES data).
  \end{enumerate}
\item
  \textbf{Status:} Needs drafting --- can be adapted from your existing
  explanatory notes and meeting summaries.
\end{itemize}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\subsubsection{\texorpdfstring{\textbf{2. Notation and
Definitions}}{2. Notation and Definitions}}\label{notation-and-definitions}
...
\item
  ...
  \item
    \emph{rₘᵢₙ} (minimum attainable correlation), \emph{rₘₐₓ} (maximum
  ...
  \item
    Metrics of constraint: width (\emph{rₘₐₓ -- rₘᵢₙ}), asymmetry index.
  \end{itemize}
\item
  Clarify measurement levels (ordinal vs.~interval) and implications for
  \emph{r²}.
\item
  \textbf{Status:} Partially drafted in Cees's Section 3--4 notes.
\end{itemize}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\subsubsection{\texorpdfstring{\textbf{3. Theoretical
Results}}{3. Theoretical Results}}\label{theoretical-results}

\begin{itemize}
\item
  \textbf{3.1 Worked Examples}

  \begin{itemize}
  \item
    Table 2 (4-category, 12 obs) --- shows symmetry and asymmetry cases.
  \item
    Patterns where \emph{rₘᵢₙ} ≠ --\emph{rₘₐₓ}.
  \item
    Cases with \emph{rₘₐₓ} = 1 but \emph{rₘᵢₙ} \textgreater{} --1, and
    vice versa.
  \item
    \textbf{Status:} Table 2 drafted; text explanation partial.
  \end{itemize}
\item
  \textbf{3.2 General Conditions for Symmetry}
  ...
  \item
    \textbf{Status:} Partially explained in meetings; needs formal
    statement.
  \end{itemize}
\item
  \textbf{3.3 Extreme Values Not at ±1}

  \begin{itemize}
  \item
    Theoretical explanation for why perfect correlation may be
    unattainable.
  \item
    \textbf{Status:} Requires concise proof/derivation.
  \end{itemize}
\item
  \textbf{3.4 Literature Connections}

  \begin{itemize}
  \item
    Relation to Fréchet--Hoeffding bounds, medical ``reference
    intervals''.
  \item
    \textbf{Status:} Notes exist; needs integration.
  \end{itemize}
\end{itemize}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\subsubsection{\texorpdfstring{\textbf{4. Rescaling and
Interpretation}}{4. Rescaling and Interpretation}}\label{rescaling-and-interpretation}

\begin{itemize}
\item
  \textbf{4.1 Why Rescale?}
  ...
  \end{itemize}
\item
  \textbf{4.2 Rescaling Methods}

  \begin{enumerate}
  \def\labelenumi{\arabic{enumi}.}
  \item
    Linear transform to {[}0, 1{]} using \emph{rₘᵢₙ} and \emph{rₘₐₓ}.
  \item
    Transform then square to yield ratio-level shared variance.
  \item
    Optional asymmetry-aware adjustments.
  \end{enumerate}
\item
  \textbf{4.3 Guidance for Applied Use}
  ...
  \end{itemize}
\item
  \textbf{Status:} Initial logic drafted by Scott; needs fleshing out
  and examples.
\end{itemize}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\subsubsection{\texorpdfstring{\textbf{5. Metrics of
Constraint}}{5. Metrics of Constraint}}\label{metrics-of-constraint}

\begin{itemize}
\item
  Bound width (\emph{rₘₐₓ -- rₘᵢₙ}).
\item
...
\item
  ...
  \end{itemize}
\item
  \textbf{Status:} Concept defined; formulae/examples still to be
  finalized.
\end{itemize}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\subsubsection{\texorpdfstring{\textbf{6. Implications, Issues, and
Questions}}{6. Implications, Issues, and Questions}}\label{implications-issues-and-questions}

\begin{itemize}
\item
  \textbf{Interpretation of `Effect Size'}
  ...
  \end{itemize}
\item
  \textbf{Comparison Across Studies / Measures}
...
\item
  ...
  \end{itemize}
\item
  \textbf{Status:} Discussion exists in fragments; needs integration.
\end{itemize}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\subsubsection{\texorpdfstring{\textbf{7. Simulation Study (Monte
Carlo)}}{7. Simulation Study (Monte Carlo)}}\label{simulation-study-monte-carlo}

\begin{itemize}
\item
  \textbf{Purpose:} Explore patterns noted in Sections 3--6 under random
  and controlled marginals.
\item
  Design:
  ...
  \item
    Compute \emph{rₘᵢₙ}, \emph{rₘₐₓ}, constraint metrics.
  \end{itemize}
\item
  Output:
  ...
  \item
    Scatterplots of observed \emph{r̂} vs.~attainable range.
  \end{itemize}
\item
  \textbf{Status:} Simulation code partially written by Scott; needs
  full implementation.
\end{itemize}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\subsubsection{\texorpdfstring{\textbf{8. Empirical Illustration (BES
Data)}}{8. Empirical Illustration (BES Data)}}\label{empirical-illustration-bes-data}
...
\subsubsection{\texorpdfstring{\textbf{9. Discussion and
Implications}}{9. Discussion and Implications}}\label{discussion-and-implications}
...
\item
  \textbf{Status:} Will be final writing task.
\end{itemize}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\subsubsection{\texorpdfstring{\textbf{Appendices}}{Appendices}}\label{appendices}
...
\item
  \textbf{Status:} Will grow as paper is drafted.
\end{itemize}
...
Questions}\label{implications-issues-and-questions-1}
