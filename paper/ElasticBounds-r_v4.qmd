...
- Overview of limitations in current correlation testing with ordinal data
...
- By the Hardy–Littlewood–Pólya Rearrangement Inequality [@hard52], this explicitly constructed pairing yields the maximum possible sum of product[@hard52-inequalities]s, hence maximizing $E[XY]$.
...
- **PCA and Factor Analysis**: Attenuated correlations may lead to  $\leadsto$
	-   Practical risks: over-factoring (more factors estimated than 'should be'), biased structural coefficients(?)
