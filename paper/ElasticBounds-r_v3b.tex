...
(\citeproc{ref-hard52-inequalities}{Hardy et al., 1952})
...
\item
  ...
  (\citeproc{ref-hard52}{\textbf{hard52?}}), this explicitly constructed
  pairing yields the maximum possible sum of
  product(\citeproc{ref-hard52-inequalities}{Hardy et al., 1952})s,
  hence maximizing \(E[XY]\).
\end{itemize}
...
{[}TO DO: define these. Add others? {]} Measures of 'asymmetry

Aitchison distance (Aitchison (\citeproc{ref-aitc89-measures}{1989}))
...
\subsection{Illustration with `Typical' Data:
...
\tightlist
\item
  \textbf{PCA and Factor Analysis}: Attenuated correlations may lead to
  \(\leadsto\)

  \begin{itemize}
  \item
    Practical risks: over-factoring (more factors estimated than `should
    be'), biased structural coefficients(?)
  \item
    \textbf{SEM}: Biased estimation of structural paths if ordinal-level
...
\bibitem[\citeproctext]{ref-aitc89-measures}
Aitchison, J. (1989). Measures of location of compositional data sets.
\emph{Mathematical Geology}, \emph{21}(7, 7), 787--790.
\url{https://doi.org/10.1007/BF00893322}
